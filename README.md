...
## Fitness edition: Training + Ernährung + Coach

Diese Variante ergänzt openGym um einen orangefarbenen Ernährungsmodus, ohne den
bestehenden Trainingsmodus zu ersetzen. Enthalten sind ein Kalorien- und
Makro-Tagebuch, Wassertracking, Barcode-Suche über Open Food Facts, optionale
Mealie-Rezepte sowie eine Ampel-Auswertung für Gewichtstrend, Ernährung,
Trainingskonstanz und progressive Überlastung. Ein optionaler KI-Anbieter kann
daraus Vorschläge machen; Änderungen an Kalorien oder Trainingsplänen werden erst
nach Bestätigung übernommen.
...
- 🥗 **Nutrition mode** — daily calories, macros, reusable foods, meal diary, water target, Open Food Facts barcode scan and optional Mealie recipe import
- 🚦 **Training + nutrition coach** — traffic lights for weight trend, logging, targets, consistency and progressive overload; optional AI proposals are review-only
