...
export default {
  ...
  "This browser doesn't support passkeys — you can still use AthletiQ locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar AthletiQ localmente en este dispositivo.',
  ...
  'Passkeys need HTTPS outside localhost. Open AthletiQ through your HTTPS domain; the current address is {0}.': 'Las passkeys requieren HTTPS fuera de localhost. Abre AthletiQ mediante tu dominio HTTPS; la dirección actual es {0}.',
  'Passkey setup does not match this address. Check the public domain or reverse-proxy headers. Details: {0}': 'La configuración de passkeys no coincide con esta dirección. Comprueba el dominio público o los encabezados del proxy inverso. Detalles: {0}',
  ...
  'to install AthletiQ as a full-screen app.': 'para instalar AthletiQ como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if AthletiQ is closed.': 'Avisos del temporizador de descanso, incluso con AthletiQ cerrado.',
  ...
  'A small file a friend imports into their own AthletiQ — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio AthletiQ: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Reload AthletiQ': 'Recargar AthletiQ',
