...
export default {
  ...
  "This browser doesn't support passkeys — you can still use AthletiQ locally on this device.": 'Этот браузер не поддерживает ключи доступа — но AthletiQ можно использовать локально на этом устройстве.',
  ...
  'Passkeys need HTTPS outside localhost. Open AthletiQ through your HTTPS domain; the current address is {0}.': 'Вне localhost для ключей доступа требуется HTTPS. Откройте AthletiQ через свой HTTPS-домен; текущий адрес: {0}.',
  'Passkey setup does not match this address. Check the public domain or reverse-proxy headers. Details: {0}': 'Настройка ключей доступа не соответствует этому адресу. Проверьте публичный домен или заголовки обратного прокси. Подробности: {0}',
  ...
  'to install AthletiQ as a full-screen app.': 'чтобы установить AthletiQ как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if AthletiQ is closed.': 'Оповещения таймера отдыха, даже если AthletiQ закрыт.',
  ...
  'A small file a friend imports into their own AthletiQ — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой AthletiQ — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload AthletiQ': 'Перезагрузить AthletiQ',
