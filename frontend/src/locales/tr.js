...
export default {
  ...
  "This browser doesn't support passkeys — you can still use AthletiQ locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de AthletiQ’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'Passkeys need HTTPS outside localhost. Open AthletiQ through your HTTPS domain; the current address is {0}.': 'localhost dışında geçiş anahtarları için HTTPS gerekir. AthletiQ’yu HTTPS alan adınız üzerinden açın; geçerli adres {0}.',
  'Passkey setup does not match this address. Check the public domain or reverse-proxy headers. Details: {0}': 'Geçiş anahtarı kurulumu bu adresle eşleşmiyor. Genel alan adını veya ters proxy üst bilgilerini kontrol edin. Ayrıntılar: {0}',
  ...
  'to install AthletiQ as a full-screen app.': 'ile AthletiQ’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if AthletiQ is closed.': 'AthletiQ kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own AthletiQ — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi AthletiQ\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
