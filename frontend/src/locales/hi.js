...
export default {
  ...
  'No': 'नहीं',
  'Note': 'नोट',
  'Set a goal': 'लक्ष्य निर्धारित करें',
  'On 🔔': 'चालू 🔔',
  'Off 🔕': 'बंद 🔕',
  'Skip': 'छोड़ें',
  'New': 'नई',
  ...
  "This browser doesn't support passkeys — you can still use AthletiQ locally on this device.": 'यह ब्राउज़र पासकी सपोर्ट नहीं करता — फिर भी आप इस डिवाइस पर AthletiQ लोकली इस्तेमाल कर सकते हैं।',
  ...
  'Passkeys need HTTPS outside localhost. Open AthletiQ through your HTTPS domain; the current address is {0}.': 'localhost के बाहर पासकी के लिए HTTPS आवश्यक है। AthletiQ को अपने HTTPS डोमेन से खोलें; वर्तमान पता {0} है।',
  'Passkey setup does not match this address. Check the public domain or reverse-proxy headers. Details: {0}': 'पासकी सेटअप इस पते से मेल नहीं खाता। सार्वजनिक डोमेन या रिवर्स-प्रॉक्सी हेडर जाँचें। विवरण: {0}',
  ...
  'to install AthletiQ as a full-screen app.': 'से AthletiQ को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'Rest-timer alerts, even if AthletiQ is closed.': 'आराम टाइमर अलर्ट, AthletiQ बंद होने पर भी।',
  ...
  'A small file a friend imports into their own AthletiQ — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने AthletiQ में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  'Reload AthletiQ': 'AthletiQ फिर से लोड करें',
