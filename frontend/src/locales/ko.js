...
export default {
  ...
  "This browser doesn't support passkeys — you can still use AthletiQ locally on this device.": '이 브라우저는 패스키를 지원하지 않아요 — 그래도 이 기기에서 AthletiQ을 로컬로 사용할 수 있습니다.',
  ...
  'Passkeys need HTTPS outside localhost. Open AthletiQ through your HTTPS domain; the current address is {0}.': 'localhost 외부에서는 패스키에 HTTPS가 필요합니다. HTTPS 도메인을 통해 AthletiQ을 여세요. 현재 주소: {0}.',
  'Passkey setup does not match this address. Check the public domain or reverse-proxy headers. Details: {0}': '패스키 설정이 이 주소와 일치하지 않습니다. 공개 도메인 또는 리버스 프록시 헤더를 확인하세요. 세부 정보: {0}',
  ...
  'to install AthletiQ as a full-screen app.': '하면 AthletiQ을 전체 화면 앱으로 설치할 수 있어요.',
  ...
  'Rest-timer alerts, even if AthletiQ is closed.': 'AthletiQ이 닫혀 있어도 휴식 타이머 알림을 받아요.',
  ...
  'A small file a friend imports into their own AthletiQ — routines only, none of your workouts or weigh-ins.': '친구가 자신의 AthletiQ으로 가져올 수 있는 작은 파일 — 루틴만 포함되며 운동 기록이나 체중은 포함되지 않습니다.',
