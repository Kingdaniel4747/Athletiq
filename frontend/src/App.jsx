...
import NutritionHome from './views/NutritionHome.jsx'
...
function applyPrefs(theme, accent, mode) {
  const de = document.documentElement
  de.dataset.theme = theme === 'light' ? 'light' : 'dark'
  de.dataset.mode = mode
  de.dataset.accent = mode === 'nutrition' ? 'orange' : ACCENTS[accent] ? accent : 'lime'
...
function Shell() {
  ...
  useEffect(() => { applyPrefs(S.theme, S.accent, nutritionMode ? 'nutrition' : 'training') }, [S.theme, S.accent, nutritionMode])
