// AthletiQ icon set — hand-drawn on a 24×24 grid, stroke-based, single weight.
//
...
const P = {
  ...
  food: <><path d="M7 3.8v6.1M4.8 3.8v4.5A2.2 2.2 0 0 0 7 10.5a2.2 2.2 0 0 0 2.2-2.2V3.8M7 10.5v9.7" /><path d="M16.8 20.2V4.9c0-.8.6-1.4 1.4-1.4h.2v9.1h-3.1" /></>,
  scan: <><path d="M8.2 4H5.8A1.8 1.8 0 0 0 4 5.8v2.4M15.8 4h2.4A1.8 1.8 0 0 1 20 5.8v2.4M20 15.8v2.4a1.8 1.8 0 0 1-1.8 1.8h-2.4M8.2 20H5.8A1.8 1.8 0 0 1 4 18.2v-2.4" /><path d="M7.2 8v8M10.2 8v8M13.8 8v8M16.8 8v8" /></>,
  ...
  copy: <><rect x="7.2" y="7.2" width="12.4" height="12.4" rx="2.2" /><path d="M16.8 7.2V6.4a2 2 0 0 0-2-2H6.4a2 2 0 0 0-2 2v8.4a2 2 0 0 0 2 2h.8" /></>,
  bookmark: <path d="M7 4.2h10a1.5 1.5 0 0 1 1.5 1.5v14.1L12 16.2l-6.5 3.6V5.7A1.5 1.5 0 0 1 7 4.2Z" />,
  ...
  book: <><path d="M4.2 5.5A2.5 2.5 0 0 1 6.7 3h4.8v16H6.7a2.5 2.5 0 0 0-2.5 2Z" /><path d="M19.8 5.5A2.5 2.5 0 0 0 17.3 3h-4.8v16h4.8a2.5 2.5 0 0 1 2.5 2Z" /></>,
  drop: <path d="M12 3.4S6.4 9.7 6.4 14a5.6 5.6 0 0 0 11.2 0C17.6 9.7 12 3.4 12 3.4Z" />,
