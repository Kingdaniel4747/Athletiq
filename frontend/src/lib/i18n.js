...
const nutritionLocalePacks = import.meta.glob('../nutrition-locales/*.js')
...
export async function setLang(l) {
  ...
  let dict = {}, instr = null
  try {
    const core = l === 'en' ? {} : (await localePacks['../locales/' + l + '.js']()).default
    const featureLoader = nutritionLocalePacks['../nutrition-locales/' + l + '.js']
    const nutrition = featureLoader ? (await featureLoader()).default : {}
    dict = { ...core, ...nutrition }
